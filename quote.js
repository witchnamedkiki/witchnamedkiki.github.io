(function () {
  const facts = [
    {
      ...
      source:
        "https://www.remindmagazine.com/article/20100/murder-she-wrote-angela-lansbury-fun-fact-things-you-didnt-know-trivia/?utm_source=chatgpt.com",
    },
    {
    ...
    },
    {
      ...
      source:
        "https://people.com/tv/how-angela-lansbury-landed-her-murder-she-wrote-role-exclusive/",
    },
    {
      ...
      source:
        "https://www.remindmagazine.com/article/20100/murder-she-wrote-angela-lansbury-fun-fact-things-you-didnt-know-trivia/",
    },
    {
      ...
      source:
        "https://www.mentalfloss.com/article/503317/9-mysterious-facts-about-murder-she-wrote",
    },
    {
  ...
  const renderFact = () => {
    ...
    if (factEl && sourceEl) {
      ...
      factEl.textContent = randomFact.fact;
      sourceEl.href = randomFact.source;
    } else {
      // Retry a bit later in case the sidebar hasn't injected yet
